    ...
    <div class="row">
      <div class="col-12 row">
        ...
        <div class="mt-4 mx-2 card col-4">
          <p style="font-size: 16px" class="px-2 py-2"><a style="text-decoration: none; color: #121212" href="{{ route('search') }}">Pencarian buku</a></h3>
          </div>
          <div class="mt-4 mx-2 card col-4">
            <p style="font-size: 16px" class="px-2 py-2"><a style="text-decoration: none; color: #121212" href="">Daftar buku yang sedang dipinjam</a></h3>
            </div>
          <!-- isi -->
        </div>
      </div>
